...
System.out.print("Incorrecto la respuesta era RAUL\n");
          ...
          System.out.println("Cual es el enenmigo de Mario?");
          String resp6 = lea.next();
           String opcion_correcta6="Bowser";
            if (resp6.equalsIgnoreCase(opcion_correcta6)){
  puntos=puntos+1;	
               System.out.print("Correcto\n");
           }
           else {
  System.out.print("Incorrecto la respuesta era BOWSER\n");
      }
            System.out.println("Personaje de Nintendo que absorve enemigos para adquirir poderes");
            String resp7 = lea.next();
             String opcion_correcta7="KIRBY";
              if (resp7.equalsIgnoreCase(opcion_correcta7)){
    puntos=puntos+1;	
                 System.out.print("Correcto\n");
             }
             else {
    System.out.print("Incorrecto la respuesta era KIRBY\n");
        }
         ...
         if (porcentaje>=80) {
            ...
            if (porcentaje>=60) {
                ...
                if (porcentaje>=40) {
                    ...
                    System.out.print("Decepcionante\n");
                }
